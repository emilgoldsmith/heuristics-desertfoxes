...
struct Move {
  ...
  long double costRelatedInfo; // This can either mean multiplication factor, updated cost of edge, or new total cost of current traversal depending on context
};
